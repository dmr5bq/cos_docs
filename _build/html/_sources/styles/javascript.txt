...
.. seealso::
    Writing a JS module for the OSF? See the :doc:`../contributing/add_ons` page in the :doc:`../contributing` section.
...
- When doing AJAX requests or other asynchronous work, it's often useful to return a promise that resolves to a useful value (e.g. model objects or "unwrapped" responses).
